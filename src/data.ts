...
export const menuData: MenuCategory[] = [
  {
    ...
    items: [
      { id: "g1", name: "فانيلا", description: "بوظة الجيلاتو الإيطالية الكلاسيكية والناعمة جداً", image: "https://www.simplyscratch.com/wp-content/uploads/2020/09/Vanilla-Bean-Gelato-l-SimplyScratch.com-homemade-fromscratch-vanilla-vanillabean-gelato-31.jpg" },
      { id: "g2", name: "شوكليت", description: "لعشاق الكاكاو، جيلاتو الشوكولاتة الداكنة أو الحليب", image: u("1572862905000-dc4ea43940c2") },
      { id: "g3", name: "فراوله", description: "جيلاتو منعش بنكهة الفراولة الطبيعية", isPopular: true, image: u("1567324216886-df4ac3ed69b0") },
      { id: "g4", name: "مانجا", description: "عشق الصيف بنكهة المانجا اللذيذة والمنعشة", image: u("1501443762994-47dd62f036fc") },
